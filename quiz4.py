...
class QuizAgent:
    def __init__(self):
        ...
        combination of both type mcqs...with code snippet, without code snippet

        Each question must strictly follow this format:
        
        Q1. [Question text]
        ```python
        [Code snippet (if applicable means not mandatory....if code snippet available then show, otherwise leave it)]
        ```
        A) [Option A]
        B) [Option B]
        C) [Option C]
